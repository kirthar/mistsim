...
TEMPLATES: dict[str, str] = {
    ...
    "reaction": "REACCIONA con {card} fuera de turno ({trigger}) sobre P{subject}",
    "sense-cut": "Sense le recorta {value} puntos de Misión (le quedan {left})",
    "mission-denied": "se queda sin puntos para avanzar en {track}",
    "sense": "Sense recorta {value} de Misión a P{victim}",
    "ally-saved": "salva a {ally} del ataque de P{by}",
